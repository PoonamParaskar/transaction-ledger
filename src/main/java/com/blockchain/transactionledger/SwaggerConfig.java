...
public class SwaggerConfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Blockchain Application").description("API reference guide for developers").termsOfServiceUrl("https://www.javacodegeeks.com/").contact("Shubham, Raut").version("1.0").build();	
	}
